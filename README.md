...
```
╔══════════════════════════════════════════════════╗
║  while (tired) { coffee++; keep_going(); }  🐱  ║
╚══════════════════════════════════════════════════╝
```

# hi, i'm intan amelia 🖤

*statistics student · aspiring data person · debug life enthusiast*

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=14&pause=1000&color=888888&center=true&vCenter=true&width=435&lines=turning+numbers+into+stories+%F0%9F%93%8A;still+figuring+out+python+%F0%9F%90%8D;coffee+first%2C+data+second+%E2%98%95;cat+sticker+on+laptop+%3A+mandatory+%F0%9F%90%BE" alt="Typing SVG" />
...
```python
intan = {
    "university" : "statistics, year 1 🎓",
    "currently"  : "surviving intro stats & falling in love with data",
...
| now learning | exploring soon | always |
|:---:|:---:|:---:|
...
```
📍 Jakarta, Indonesia
📚 Learning the basics — one dataset at a time
🔭 Looking for: internships, projects, collab ideas
🌱 Currently studying: descriptive stats, probability, intro to Python
💭 Dream: make data tell stories people actually care about
🐱 Mood: focused but make it cute
```
...
```
╔═══════════════════════════════════╗
║  code · cute · coffee · repeat ♡ ║
╚═══════════════════════════════════╝
```

![](https://komarev.com/ghpvc/?username=intanamelia&color=c678dd&style=flat-square&label=visitors)
